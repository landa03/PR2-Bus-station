    ...
    class Menu
    {
        ...
        */
        ...
        private void DisplayMainMenuOptions() { // esto es lo que te dice la consola
            ...
            System.Console.WriteLine("3) Imprimir data de camiones");
            System.Console.WriteLine("4) Borrar data de camiones");
            System.Console.WriteLine("5) Camiones en la estacion");
            System.Console.WriteLine();
            ...
            while (selectedOption != MAIN_MENU_EXIT_OPTION) {
                ...
                switch (selectedOption) 
                {
                    ...
                    case 3: //data de camiones
                        ...
                        break;
                    case 4: //
                        namesMemory.DequeueAll();
                        rautsMemory.DequeueAll();
                        System.Console.WriteLine("la memoria se formateo exitosamente");
                        break;
